...
using WCCIOct30_2017CarDealershipDBPractice.Models;

namespace WCCIOct30_2017CarDealershipDBPractice.Controllers
{
    public class Car_BuyerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Car_BuyerID,BuyerID,CarID")] Car_Buyer car_Buyer)
        {
            ...
            ViewBag.CarID = new SelectList(db.Cars, "CarID", "VIN", car_Buyer.CarID);
            return View(car_Buyer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Car_BuyerID,BuyerID,CarID")] Car_Buyer car_Buyer)
        {
            if (ModelState.IsValid)
            {
